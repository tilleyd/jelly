#ifndef _GELI_CORE_MODEL_H_
#define _GELI_CORE_MODEL_H_
    ...
    namespace core
    {
        ...
        class Model
        {
            ...
            public:
                 ...
                 *
                 * \param vert
                 *     The array of vertices. The vertex array must be in the
                 *     format { x1, y1, z1 ... xn, yn, zn}.
                 * \param n
                 *     The number of vertices, *not* the number of elements in
                 *     the array (length of vert is assumed to be 3 * n).
                 * \param mode
                 *     The OpenGL rendering mode used to render the vertices
                 *     such as GL_POINTS, GL_LINE_STRIP, GL_TRIANGLES, etc.
                 **/
